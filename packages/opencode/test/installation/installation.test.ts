  ...
  describe("latest", () => {
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("leduyphuc1702/tap/opencode")) return ""
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("leduyphuc1702/tap/opencode") && args.includes("--formula")) return "opencode"
